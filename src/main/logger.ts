...
const NHAN_LOI: [RegExp, string][] = [
  ...
  [/upstream governor is blocked|recovered-from-store/i, 'Gemini Gateway đang tạm khóa (hãy thử lại hoặc khởi động lại Gateway)'],
  [/\bgeo[_-]?(?:restrict|block)|not available in your (?:country|region)|blocked in your (?:country|region)|\bcountry\b/i, 'nội dung bị chặn theo khu vực'],
