...
const knownTests = [
  ...
  'autoshort-provider-wait.test',
  'gateway-batch-recovery.test',
  'gateway-deferred-propagation.test',
  'gateway-restoration-pipeline.test',
  'autoshort-source-restoration.test',
  ...
  'translation-labeled-response.test',
  'translation-prompts.test',
  'translation-rephrase.test',
  'translation-semantic-evidence.test',
  'translation-budget.test',
  'translation-capability-snapshot.test',
  'translation-request-budget.test',
  'speech-unit-plan.test',
  'speech-unit-planner.test',
  'speech-budget.test',
  'vietnamese-style-profile.test',
  'vietnamese-evaluation.test',
  ...
  'gemini-gateway-text-output.test',
  'gemini-gateway-long-context.test',
  'gemini-gateway-prompts.test',
  'gemini-gateway-draft-resume.test',
  'gemini-gateway-operations.test',
  'gemini-keys.test',
