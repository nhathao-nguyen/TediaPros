# Inference subset adapted from researchmm/STTN (MIT).
# Source commit f39f62c5bbbe3e3eba084c487353a2c651bfdcde, model/sttn.py.
# Modified: omit training/discriminator/initializers and unused torchvision imports.
# Keep parameter names/shapes compatible with the pinned netG checkpoint.
import math
import torch
